...
//    private LineAndPointFormatter lineFormatterChannelFour;
    ...
    public CircularBuffer eegBuffer = new CircularBuffer(220, 1);
...
//    int average_channel_4 = 0;
    ...
    // variar para encontrar la señal
...
//        }
    ...
    public void initUI() {
        // Tomala da tada y la imprime en graficas
...
//        initViewChannel4(this);
        ...
        txtAverage_channel_1 = findViewById(R.id.AvChanel1);
...
// setea las configuracions al framlayaut-plot
    public void initViewChannel1(Context context) {

        FrameLayout frameLayout = findViewById(R.id.XPlot1);
...
//        }
    ...
    public void startDataListener() {
        if (dataListener == null) {
            ...
            // inicialisar la toma de datos con una respuesta del cliente.
        }
    ...
    private final class DataListener {
        ...
        // recibe la data
            ...
            // hacer que imprimia la data socket
/*
...
//                txtAverage_channel_4.setText("Promedio: " + (average_channel_4));
        ...
        // transforma a un vector la data recibida - string a un vector float
